...
class ArticleController extends CommonController {
    ...
    public function index(){
            ...
            $list = $m->field("a.*,(SELECT name FROM {$prefix}category where id = a.fid) as category")->table("{$prefix}article as a")->where("status = 0")->order('id desc')->limit($Page->firstRow.','.$Page->listRows)->select();
