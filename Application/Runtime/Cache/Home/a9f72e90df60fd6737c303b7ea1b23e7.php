...
<div class="main">
    ...
    <div class="w1002">
        <div class="s-zytop">
            <ul class="clearfix">
                <li>当前位置：<a href='/'>主页</a> > <a href='#'>水果专区</a> > <a href="#"><?php echo ($category); ?></a></li>
        ...
        <div class="zy-mume  clearfix">
            <ul>
                <?php if(is_array($productCategory)): foreach($productCategory as $key=>$val): ?><li>
                        <h2><a class="sid_<?php echo ($val["id"]); ?>"
                               href="<?php echo U('Category/index', array('cid'=> $cid, 'sid'=>$val['id']));?>"><?php echo ($val["name"]); ?></a>
                        </h2>
            ...
            <div class="cplist">
                <ul class="clearfix">
                    <?php if(is_array($productList)): foreach($productList as $key=>$val): ?><li>
                            <a class="cpimg" href="<?php echo U('Category/product', array('cid'=> $cid,'id'=>$val['id']));?>" >
                                <img src="<?php echo ($val["pic"]); ?>" width="300" height="300"/>
                            </a>
                            <h3>
                                <a href="<?php echo U('Category/product', array('cid'=> $cid,'id'=>$val['id']));?>"><?php echo ($val["title"]); ?></a>
                            </h3>
                            <a class="ckxx" href="<?php echo U('Category/product', array('cid'=> $cid,'id'=>$val['id']));?>">了解详情</a>
                            <a href="<?php echo U('Category/product', array('cid'=> $cid,'id'=>$val['id']));?>" class="s-cphover"></a>
                        </li><?php endforeach; endif; ?>
                </ul>
