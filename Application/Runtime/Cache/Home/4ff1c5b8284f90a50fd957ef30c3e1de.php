            ...
            <div class="s-cplist">
                <ul class="clearfix">
                    <?php if(is_array($products)): foreach($products as $key=>$val): ?><li>
                            <a href="<?php echo U('Category/product', array('id'=>$val['id']));?>" title="<?php echo ($val["title"]); ?>">
    ...
    <div class="w1002">
        <div class="s-news">
            <div class="s-yzcpbt s-newsbt">
                <h2 class="l-synewsem"><a href="#" target="_blank">company news center</a></h2>
                <h2 class="l-synews"><a class="l-newschinatit" href="#" target="_blank">公司新闻</a>
                </h2>
            </div>
            <div class="s-newsnr">
