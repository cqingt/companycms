...
<div id="header" class="clearfix" style="position:relative;">
    ...
    <div class="cpaut"><?php echo ($category["name"]); ?></div>
    <div class="flbox"><img src="/Public/Mobile/images/fl.jpg" alt="分类"></div>
</div>
<div class="wap-lm">
    <?php if(is_array($newsCategory)): foreach($newsCategory as $key=>$val): ?><a href="<?php echo U('Category/index', array('mobile'=>1,'cid' => $cid,'sid'=>$val['id']));?>" class="new_item sid_<?php echo ($val["id"]); ?>" data-cid="<?php echo ($val["id"]); ?>"><?php echo ($val["name"]); ?></a><?php endforeach; endif; ?>
</div>
