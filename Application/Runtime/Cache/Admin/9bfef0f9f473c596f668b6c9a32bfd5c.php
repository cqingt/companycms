            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if(is_array($arr)): foreach($arr as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td>
                           <a href="<?php echo U('Category/edit',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-w-m btn-info">修改</button></a>
                            <a href="<?php echo U('Category/delete',array('id'=>$vo['id']));?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>
