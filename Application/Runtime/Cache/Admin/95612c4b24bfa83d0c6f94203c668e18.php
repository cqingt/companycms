                   ...
                   <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="hr-line-dashed"></div>
                            <form method="post" class="form-horizontal" action="<?php echo U('Category/doadd');?>">
                                ...
                                <div class="form-group"><label class="col-sm-4 control-label">上级分类</label>
                                    ...
                                    <select name="fid" class="form-control m-b">
                                        ...
                                        <?php if(is_array($arr)): foreach($arr as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["html"]); echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                    </div>
                                </div>
                                 <div class="hr-line-dashed"></div>
                                ...
                                <!--<div class="form-group has-success">
                                    <label class="col-sm-4 control-label">分类样式</label>
                                    <div class="col-sm-3">
                                         <select name="type" class="form-control m-b">
                                            <?php if(is_array($category_type)): foreach($category_type as $k=>$vo): ?><option value="<?php echo ($category_type[$k]); ?>"><?php echo ($k); ?></option><?php endforeach; endif; ?>
                                        </select>
                                     </div>
                                </div>
                                <div class="hr-line-dashed"></div>-->
                                ...
                                <div class="form-group has-success">
                                    <label class="col-sm-4 control-label">首页显示位置</label>
                                    <div class="col-sm-3">
                                        <label class="radio-inline">
                                            <input type="radio" name="show_index" value="" checked="checked"> 不展示
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="show_index" value="center"> 首页居中
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="show_index"  value="bottom"> 首页底部
                                        </label>
                                    </div>
                                </div>
                               <div class="ibox-content">
