                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td>
                           ...
                           <a href="<?php echo U('Article/update',array('id'=>$vo['id']));?>" target="_blank"><button type="button" class="btn btn-w-m btn-info">修改</button></a>
                            <a href="<?php echo U('Article/delete',array('id'=>$vo['id']));?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>
...
<script>
    ...
    <script src="/Public/Default/js/plugins/dataTables/dataTables.responsive.js"></script>
    <script src="/Public/Default/js/plugins/dataTables/dataTables.tableTools.min.js"></script>