...
<div id="page-wrapper" class="gray-bg" style="overflow: hidden;">
    <div class="row border-bottom">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <form method="post" class="form-horizontal" action="<?php echo U('Article/do_update',array('id'=>$article_info['id']));?>" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-7">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="hr-line-dashed"></div>
                                <div class="form-group has-success">
                                    ...
                                    <div class="col-sm-9"><input type="text" class="form-control" name="title" required id="title" value="<?php echo ($article_info["title"]); ?>"></div>
                                </div>
                                ...
                                <div class="form-group has-success" style="display: none;">
                                    <div class="col-sm-12">
                                      <div class="row">
                                        ...
                                        <div class="col-md-3">
                                          <input class="form-control" type="text" placeholder="没有密码留空" name="articlepassword" value="<?php echo ($article_info["articlepassword"]); ?>">
                                        </div>
                                        <label class="col-sm-3 control-label">封面是否显示：</label>
                                        <div class="col-md-3">
                                          <select name="viewtumb" id="" class="form-control">
                                          <option value="0" <?php if($article_info["viewtumb"] == 0): ?>selected = 'true'<?php endif; ?>>是</option>
                                          <option value="1" <?php if($article_info["viewtumb"] == 1): ?>selected = 'true'<?php endif; ?>>否</option>
                                          </select>
                                        </div>
                                      </div>
                                    </div>
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <div class="col-sm-3">
                                      <select name="fid" class="form-control m-b">
                                        <?php if(is_array($category)): foreach($category as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if($article_info["fid"] == $vo['id']): ?>selected = 'selected'<?php endif; ?>><?php echo ($vo["html"]); echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                    </div>
                                    <label class="col-sm-3 control-label">文章样式：</label>
                                    <div class="col-sm-3">
                                      <select name="type" class="form-control m-b" id="article_style">
                                        <?php if(is_array($article_type)): foreach($article_type as $k=>$vo): ?><option value="<?php echo ($article_type[$k]); ?>" <?php if($article_info["type"] == $article_type[$k]): ?>selected = 'selected'<?php endif; ?>><?php echo ($k); ?></option><?php endforeach; endif; ?>
                                    </select>
                                    </div>
                                </div>
                            <div class="form-group has-success additional" style="display:none">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-control" type="text" placeholder="产品价格" name="price" value="<?php echo ($article_info["price"]); ?>">
                                </div>
                            </div>
                            <div class="form-group has-success additional" style="display:none">
                                <label class="col-sm-3 control-label">附加说明：</label>
                                <div class="col-sm-6">
                                    <textarea name="additional" cols="40" rows="5" placeholder="附加说明，多项以 | （竖线）分隔"><?php echo ($article_info["additional"]); ?></textarea>
                                </div>
                            </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group has-success">
                                    <textarea id="editor" placeholder="这里输入内容" name="content"><?php echo ($article_info["content"]); ?></textarea>
                                </div>
                        </div>
                    </div>
                  ...
                  <div class="mail-body">
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="pic" id = "pic" value="<?php echo ($article_info["pic"]); ?>">
                            </div>
                            <div class="col-sm-12">
                                <img src="<?php echo ($article_info["pic"]); ?>" alt="" width="400">
                            </div>
                        </div>
                    </div>
                  </div>
                  ...
                  <div class="mail-body">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="mp3" id = "mp3" value="<?php echo ($article_info["mp3"]); ?>">
                                </div>
                        </div>
                    </div>
                  </div>
                  ...
                  <div class="mail-body">
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                          ...
                          <div class="col-sm-12">
                              <input type="text" class="form-control" name="file" id = "file" value="<?php echo ($article_info["file"]); ?>">
                          </div>
                        </div>
                    </div>
                  </div>
                  ...
                  <div class="mail-body">
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-body">
                          ...
                          <div class="col-sm-12">
                              <input type="text" class="form-control" name="video" id = "video" value="<?php echo ($article_info["video"]); ?>">
                          </div>
                        </div>
                    </div>
                  </div>
